...
public class LobbyCreateUI : MonoBehaviour {
    ...
    private void Awake() {
        ...
        gameModeButton.onClick.AddListener(() => {
            switch (gameMode) {
                default:
                case LobbyManager.GameMode.ThreeLives:
                    gameMode = LobbyManager.GameMode.OneLive;
                    break;
                case LobbyManager.GameMode.OneLive:
                    gameMode = LobbyManager.GameMode.ThreeLives;
                    break;
            }
            UpdateText();
        });
